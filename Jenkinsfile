      ...
      steps {
          ...
          container('docker') {
             ...
             sh """
              ...
              docker login nexus.tools.aws.cps.example.com --username ${USERNAME} --password ${PASSWORD}

             echo "STARTED: Docker image build"
             docker build  -t nexus.tools.aws.cps.example.com/demo-app:latest .

             echo "STARTED: Docker images push"
             docker push nexus.tools.aws.cps.example.com/demo-app:latest
              """
